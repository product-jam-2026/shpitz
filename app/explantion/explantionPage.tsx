...
const explanationSteps = [
    ...
    { // שלב 6 - הסבר על הוראות
        body: "חזרו לעמוד זה והיזכרו כיצד לשחק",
        showOverlay: true,
    ...
    return (
        <div className={styles.pageWrapper}>
            <div className={styles.container} dir="rtl">
                ...
                {/* 2. כותרת השאלה */}
                <h2 className={styles.questionTitle}>האם הייתם פותחים<br />את הלינק?</h2>
                ...
                <div className={styles.actionGrid}>
                    <button className={`
            ${styles.smallToolButton} 
            ${stepData.isHintStep ? styles.highlightHint : ""}
        `}><span>רמז</span></button>
                    <button className={`
        ${styles.smallToolButton} 
        ${stepData.isInstructionsStep ? styles.highlightHint : ""}
    `}>? הוראות</button>
                    <button className={`${styles.squareButton} ${stepData.isActionsStep && !stepData.isFeedbackStep ? styles.highlight : ""}`}>לפתוח</button>
                    <button className={`${styles.squareButton} ${stepData.isActionsStep && !stepData.isFeedbackStep ? styles.highlight : ""}`}>לדווח</button>
                </div>
                ...
                {!isFinished && stepData.showOverlay && (
                    <div className={styles.overlay} onClick={handleNextStep}>
                        ...
                        {stepData.isFeedbackStep && <ConfettiEffect />}

                        {/* --- שלב 3: אלמנטים שנעלמים בספירלה כשעוברים לשלב 4 --- */}
                            ...
                            <>
                                ...
                                <div className={styles.actionsExplanationArea}>
                                    ...
                                    <div className={styles.customArrowsContainer} style={{bottom: '120px'}}>
                                        <svg className={styles.customArrowSvg} width="37" height="103" viewBox="0 0 37 103" fill="none">
                            ...
                            <div className={styles.stepAnimation}>
                                <div className={styles.actionsExplanationArea}>
                                    ...
                                    <div className={styles.feedbackArrowsWrapper}>
                                        {/* חץ עליון למספר 1 */}
                                        <div className={styles.arrowTopProgress}>
                                            <svg width="37" height="103" viewBox="0 0 37 103" fill="none">
                                                <path d="M26.1152 1C27.628 2.42802 29.7238 6.19258 34.4601 30.2549C36.6132 41.1934 34.4232 53.3117 32.4146 60.9921C30.4729 68.4163 26.2367 73.9719 20.4322 83.2499C16.4635 89.5935 9.11897 94.0871 8.64154 95.084C6.28732 99.9997 21.94 91.1289 32.382 88.8162C34.7606 88.2894 36.1841 87.8586 33.5104 89.2663C15.9782 98.4974 9.1467 100.055 3.47031 101.166C-1.57992 102.155 2.50552 93.3756 3.56269 86.2493C4.47312 82.134 5.46957 77.9504 6.22239 74.2712C6.48442 72.6525 6.50283 71.5382 6.36296 67.7844" 
                                                    stroke="#CCFF00" strokeWidth="2" strokeLinecap="round"/>
                                            </svg>
                                        </div>
                                        <div className={styles.rotatedTextStep5}>
                                            <p className={styles.explanationText}>{stepData.body}</p>
                                        </div>
                                        {/* חץ תחתון לכפתור המשך */}
                                        <div className={styles.arrowBottomContinue}>
                                            <svg width="37" height="103" viewBox="0 0 37 103" fill="none">
                                                <path d="M26.1152 1C27.628 2.42802 29.7238 6.19258 34.4601 30.2549C36.6132 41.1934 34.4232 53.3117 32.4146 60.9921C30.4729 68.4163 26.2367 73.9719 20.4322 83.2499C16.4635 89.5935 9.11897 94.0871 8.64154 95.084C6.28732 99.9997 21.94 91.1289 32.382 88.8162C34.7606 88.2894 36.1841 87.8586 33.5104 89.2663C15.9782 98.4974 9.1467 100.055 3.47031 101.166C-1.57992 102.155 2.50552 93.3756 3.56269 86.2493C4.47312 82.134 5.46957 77.9504 6.22239 74.2712C6.48442 72.6525 6.50283 71.5382 6.36296 67.7844" 
                                                    stroke="#CCFF00" strokeWidth="2" strokeLinecap="round"/>
                                            </svg>
                                    ...
                                    <div className={styles.feedbackCard}>
                                        <p className={styles.feedbackText}>כל הכבוד, עוד כמה ותהיה שפיץ!</p>
                    ...
                    {stepData.isHintStep && (
                        ...
                        <div key="step-6" className={styles.hintExplanationArea}>
                            ...
                            <div className={styles.hintExplanationArea}>
                                <div className={styles.hintRotatedText}>
                                    <p className={styles.explanationText}>{stepData.body}</p>
                                </div>
            ...
            <div className={styles.instructionsRotatedText}>
                <p className={styles.explanationText}>{stepData.body}</p>
            </div>
            ...
            {!stepData.isTitleStep && !stepData.isActionsStep && !stepData.isFeedbackStep && !stepData.isHintStep && !stepData.isInstructionsStep && !stepData.isFinalStep && stepData.body && (
                <div className={styles.stepAnimation}>
